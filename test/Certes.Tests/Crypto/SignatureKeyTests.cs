...
namespace Certes.Crypto
{
    public class SignatureKeyTests
    {
        ...
        private void EnsurePropertySerializationOrder()
        {
            ...
            var ecKeyJson = System.Text.Json.JsonSerializer.Serialize(ecKey, CertesJsonSerializerContext.Default.EcJsonWebKey);
#else
...
#if NET8_0_OR_GREATER
            var rsaKeyJson = System.Text.Json.JsonSerializer.Serialize(rsaKey, CertesJsonSerializerContext.Default.RsaJsonWebKey);
#else
